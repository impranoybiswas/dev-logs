              ...
              <div className="flex flex-col md:flex-row gap-8 py-4">
                ...
                >
                  <Descriptions
                    ...
                    column={1}
                    classNames={{
                      root: "bg-muted/20! rounded-lg overflow-hidden",
                    }}
                  >
                    <Descriptions.Item
                      label={
                    ...
                    <Descriptions.Item
                      label={
                        user.gender === "male" ? (
                          <>
                            <ManOutlined className="mr-2 text-primary" />
                            Gender
                          </>
                        ) : user.gender === "female" ? (
                          <>
                            <WomanOutlined className="mr-2 text-primary" />
                            Gender
                          </>
                        ) : (
                          <>
                    ...
                    >
                      <span className="capitalize font-medium float-left">
