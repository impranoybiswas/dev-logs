...
export default function UsersPage() {
  ...
  const handleAddFriend = async (userId: string) => {
    ...
    try {
      ...
      message.error(
        axiosError.response?.data?.message || "Failed to send friend request",
      );
    } finally {
              ...
              {filteredUsers.map((user, index) => (
                ...
                >
                  <div className="relative h-full bg-card/40 backdrop-blur-xl rounded-xl border border-border/70 p-5 transition-all duration-500 hover:shadow-primary/20 dark:hover:shadow-primary/20 hover:border-primary/50 hover:-translate-y-2 overflow-hidden flex flex-col items-center text-center">
                    ...
                    {/* Content */}
                    <div className="grow w-full space-y-2 mb-5 relative z-10">
                      ...
                      <div className="inline-block px-3 py-1 rounded-lg bg-muted/50 text-muted-foreground text-xs font-bold border border-border/50 transition-colors group-hover:bg-primary/5 group-hover:text-primary/70 w-full overflow-hidden">
                        {user.email}
                      </div>
                    </div>
                      ...
                      {user.friendshipStatus === "ACCEPTED" ? (
                        ...
                        <Button
                          ...
                          style={{
                            ...
                            height: "3rem",
                            boxShadow:
                              "0 4px 6px -1px rgba(var(--error-rgb), 0.1)",
                        ...
                        <div className="flex gap-3">
                          <Button
                            ...
                            style={{
                              ...
                              flexGrow: 1,
                              boxShadow:
                                "0 4px 6px -1px rgba(var(--success-rgb), 0.2)",
                              border: "none",
                        ...
                        <Button
                          ...
                          style={{
                            ...
                            boxShadow: isLoggedIn
                              ? "0 20px 25px -5px rgba(var(--primary-rgb), 0.2)"
                              : "none",
                            border: "none",
                            transition: "all 0.3s ease",
                          }}
